...
public abstract class WorkableTieredMetaTileEntity extends TieredMetaTileEntity {
    ...
    protected IItemHandlerModifiable createImportItemHandler() {
        ...
        return new DirtyableItemStackHandler(workable.recipeMap.getMaxInputs(), this,false);
    }

    @Override
    protected IItemHandlerModifiable createExportItemHandler() {
        if (workable == null) return new ItemStackHandler(0);
        return new DirtyableItemStackHandler(workable.recipeMap.getMaxOutputs(), this,true);
    }
    ...
    protected FluidTankList createImportFluidHandler() {
        ...
        for (int i = 0; i < fluidImports.length; i++) {
            DirtyableFilteredFluidHandler filteredFluidHandler = new DirtyableFilteredFluidHandler(getInputTankCapacity(i),this,false);
    ...
    protected FluidTankList createExportFluidHandler() {
        ...
        for (int i = 0; i < fluidExports.length; i++) {
            fluidExports[i] = new DirtyableFluidTank(getOutputTankCapacity(i),this,true);
        }
